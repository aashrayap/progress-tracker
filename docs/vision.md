...
- **90-day**: dopamine reset + habit stabilization window
- **2-year**: March 2028 best-possible-self target state
...
- **90-day**: align cashflow and planning to support habit transformation without breaking long-horizon investing discipline.
- **2-year**: strengthen capital trajectory toward eight-figure optionality through focused, high-upside value creation.

### `fun`
- **Now**: replace at least one zero-sum leisure loop with a positive-sum activity that creates energy and connection.
- **90-day**: establish recurring hobbies that are restorative and social, not isolating or numbing.
